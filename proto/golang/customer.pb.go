...
func (*CustomerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_c162caf290f07bc1, []int{0}
}
...
func (*CustomerRequest_Address) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_c162caf290f07bc1, []int{0, 0}
}
...
func (*CustomerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_c162caf290f07bc1, []int{1}
}
...
func (*CustomerFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_c162caf290f07bc1, []int{2}
}
...
func init() { proto.RegisterFile("customer.proto", fileDescriptor_customer_c162caf290f07bc1) }

var fileDescriptor_customer_c162caf290f07bc1 = []byte{
